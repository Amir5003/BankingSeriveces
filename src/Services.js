...
function Services(){
    return(
        <div>
            ...
            <p>We are providing banking services to the user so that they can directly pay bill, make recharge,
		    get instant loans, insurance etc.. in very less time and conveniently.</p>
